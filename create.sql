...
constraint item_name_uk unique,
price number (6)
...
(id number (3)
constraint storages_id_pk primary key,
address varchar2 (50)
constraint storages_address_nn not null
);
...
constraint item_list_storage_id_fk foreign key (storage_id) references storages (id),
quantity number (6)
